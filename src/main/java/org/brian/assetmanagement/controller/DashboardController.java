...
public class DashboardController extends AbstractTemplateController {
	...
	public void handleHyperLinkForward(ActionEvent event) throws IOException {
		/**
		 * facade pattern implemented here. Dashboard is the facade which
		 * gives access to interract with each controller. once scene is
		 * switched, the corresponding controller takes over the control from dashboard.
		 */
